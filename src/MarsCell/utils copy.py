...
def initialisation():
    ...
    if not os.path.isfile(user_folder_created):
        ...
        user_folder_path = filedialog.askdirectory(title="Select a Folder to Save Project") #creation of a folder for more convenient access to TAPAS files
